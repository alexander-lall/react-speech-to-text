...
class SignUp extends Component {
    ...
    handleSubmit = async event => {
        ...
        try {
            const { user } = await (await createUserWithEmailAndPassword(auth, email, password)); 
        ...
        return (
            <div className="sign-up">
                ...
                <form onSubmit={this.handleSubmit}>
                    <FormInput name='displayName' type='text' value={displayName} onChange={this.handleChange} label='Dispaly Name' required />
